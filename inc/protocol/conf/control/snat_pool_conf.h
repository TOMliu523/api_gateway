...
extern int snat_conf_table_append(void **, const void *arg, struct snat_pool **, int, int);
extern int snat_conf_table_get_count(void *, int *);
extern int snat_conf_table_get_element(void *, struct snat_pool *[], int);
